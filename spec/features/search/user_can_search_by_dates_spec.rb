...
describe "As a not logged in user" do
  context "when I enter a date in the check in and check out fields" do
    ...
    it "returns the listings within the check in and check out date", :vcr do
      visit root_path
    ...
    it "returns no listings if dates are invalid", :vcr do
      visit root_path
    ...
    it "returns correct listing with valid city and date", :vcr do
      visit root_path
    ...
    it "returns no listings with invalid city and correct date" , :vcr do
    ...
    it "returns no listings with valid city and incorrect date" , :vcr do
      visit root_path
